...
int main(int argc, char *argv[]) {
 ...
 /** Command Line arguments **/
	...
	long long int t1, t2, values[1];
    int EventSet = PAPI_NULL;
    int Event = PAPI_DP_OPS;

    /**PAPI INITIALIZATION & EVENT CREATION**/
	...
	float t = (float)(t2 - t1);
	float a = (float)values[0]/t;
	t = t/1000000.;
    /********** START FINALIZATION **********/
    finalization(file_in, pre, total_iters, residual_ratio, nintci, nintcf, var, cgup, su, lcc, t, a);
    /********** END FINALIZATION **********/
